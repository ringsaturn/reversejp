...
- 🗺️ **Interactive Map**: Powered by Protomaps and MapLibre GL JS
- 📍 **Click-to-Geocode**: Click anywhere on the map to get location information
- 🎯 **Visual Markers**: Beautiful markers appear at clicked locations
- 📊 **Information Panel**: Display detailed location data including:
...
3. Click the × button to close the information panel

## Architecture

```
├── index.ts          # Bun dev server (builds and serves the app)
├── src/
│   └── app.ts        # TypeScript application (map + geocoding logic)
├── public/
│   ├── index.html    # Main HTML page
│   ├── styles.css    # Styling and animations
│   └── app.js        # Compiled JavaScript (generated by Bun)
